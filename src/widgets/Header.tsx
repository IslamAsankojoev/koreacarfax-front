        ...
        <div 
          ...
          <nav className="site-nav">
            <ul className="clean-list site-links">
              <li>
                <a href="https://wa.me/+123456789" target="_blank" className="text-white">Заказать отчет</a>
              </li>
              <li>
                <a href="https://wa.me/+123456789" target="_blank" className="text-white">Авто под заказ из Кореи</a>
              </li>
              <li>
